...
parser.add_argument('--resuming_model_path', type=str, default='/home/lkshpc/liumengzu/Code/MSFA/memory/exp/2025_05_23_19_33_29Sspa_spe_var4/model/model_392.pth', help='saving_path')
parser.add_argument('--result_path', type=str, default='result_mat/var4', help='saving_path')
# ablation 1
...
# ablation 3
# parser.add_argument('--method', type=str, default='transRWKVb1abalationtrans')
# parser.add_argument('--resuming_model_path', type=str, default='/home/liumengzu/Code/Demosaic/Compare_Method/Lightprompt/OPTDIC/exp/2025_05_15_20_12_42StransRWKVb1abalationtrans/model/model_341.pth', help='saving_path')
# parser.add_argument('--result_path', type=str, default='/home/liumengzu/Code/Demosaic/Compare_Method/Lightprompt/OPTDIC/exp/2025_05_15_20_12_42StransRWKVb1abalationtrans/model/', help='saving_path')

parser.add_argument("--resume", type=bool, default=True)
parser.add_argument("--noise_level", type=int, default=0)
parser.add_argument('--test_set', type=str, default='KAIST') # MCAN_REAL KAIST ICVL NTIRE
...
# parser.add_argument('--test_image_dir', type=str, default='/data/liumengzu/data/Dataset/ARAD_testing/test_spectr/al_16/')
parser.add_argument('--test_image_dir', type=str, default='/data/liumengzu/data/Dataset/KAIST256_16/')
# parser.add_argument('--test_image_dir', type=str, default='/data/liumengzu/data/Dataset/MCAN_REAL/')
# parser.add_argument('--test_image_dir', type=str, default='/data/liumengzu/data/Dataset/ARAD_testing/test_spectral_16/')
